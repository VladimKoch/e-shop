<?=$this->view('template/adminheader',$data)?>
	...
	<script type="text/javascript" src="<?=ADMIN?>/js/bootstrap-daterangepicker/date.js"></script>
	<script type="text/javascript" src="<?=ADMIN?>/js/bootstrap-daterangepicker/daterangepicker.js"></script>
	
	<script type="text/javascript" src="<?=ADMIN?>/js/bootstrap-inputmask/bootstrap-inputmask.min.js"></script>
