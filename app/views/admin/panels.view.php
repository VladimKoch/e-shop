					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 mb">
							...
							<div class="white-panel pn">
								...
								<p><img src="<?=ADMIN?>/img/ui-zac.jpg" class="img-circle" width="50"></p>
								<p><b>Zac Snider</b></p>
									<div class="row">
										<div class="col-md-6">
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 mb">
							<div class="content-panel pn">
								<div id="profile-02">
									<div class="user">
										<img src="<?=ADMIN?>/img/friends/fr-06.jpg" class="img-circle" width="80">
										<h4>DJ SHERMAN</h4>
									</div>
								</div>
					...
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-4 mb">
							<div class="product-panel-2 pn">
								...
								<img src="<?=ADMIN?>/img/product.jpg" width="200" alt="">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 mb">
							<div class="weather-2 pn">
								...
								<div class="row centered">
									<img src="<?=ADMIN?>/img/ny.jpg" class="img-circle" width="120">			
								</div>
								<div class="row data">
									<div class="col-sm-6 col-xs-6 goleft">
										<h4><b>16 ºC</b></h4>
