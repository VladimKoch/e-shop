<?=$this->view('template/adminheader',$data)?>
				              ...
				              <tbody>
				                <tr>
				           			<td>
				                        ...
				                        <a href="<?=PATH?>admin#">Send invoice</a></span>
				                ...
				                <tr>
				           			<td>
				                        <span class="check"><input type="checkbox" class="checked"></span>
				                        <a href="<?=PATH?>admin#">Check messages</a></span>
				                        <button class="close" aria-hidden="true" data-dismiss="alert" type="button">×</button>
									</td>
				                </tr>
				                <tr>
				            		<td>
				                        <span class="check"><input type="checkbox" class="checked"></span>
				                        <a href="<?=PATH?>admin#">Pay bills</a></span>
				                        <button class="close" aria-hidden="true" data-dismiss="alert" type="button">×</button>
									</td>
				                </tr>
				                <tr>
				            		<td>
				                        <span class="check"><input type="checkbox" class="checked"></span>
				                        <a href="<?=PATH?>admin#">Schedule site </a></span>
				                        <button class="close" aria-hidden="true" data-dismiss="alert" type="button">×</button>
									</td>
				                 </tr>
				              </tbody>
    ...
    <script src="<?=ADMIN?>/js/tasks.js" type="text/javascript"></script>
