              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub_menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="<?=PATH?>admin/orders/backup">Website Backup</a></li>
                      </ul>
                  </li>
                  <li class="sub_menu">
                      <a class="" href="javascript:;">
                      ...
                      <ul class="sub">
                          <li><a  href="<?=PATH?>admin/profiles/customers">Customer</a></li>
                          <li><a  href="<?=PATH?>admin/profiles/admins">Admin</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="<?=PATH?>admin/categories">View Category</a></li>
                          <li><a  href="<?=PATH?>admin/categories/add">Add new Category</a></li>
                          <li><a  href="<?=PATH?>admin/categories/edit">Eidt Category</a></li>
                          <li><a  href="<?=PATH?>admin/categories/delete">Delete Category</a></li>
                      </ul>
                  </li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="<?=PATH?>admin/components/calendar">Calendar</a></li>
                          <li><a  href="<?=PATH?>admin/components/gallery">Gallery</a></li>
                          <li><a  href="<?=PATH?>admin/components/todo_list">Todo List</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
                      ...
                      <ul class="sub">
                          <li><a  href="<?=PATH?>admin/extra/blank_page">Blank Page</a></li>
                          <li><a  href="<?=PATH?>admin/extra/lock_screen">Lock Screen</a></li>
                      </ul>
                  </li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="<?=PATH?>admin/graphs/morris">Morris</a></li>
                          <li><a  href="<?=PATH?>admin/graphs/chartjs">Chartjs</a></li>
                      </ul>
                  </li>
