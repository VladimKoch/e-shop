...
<footer id="footer"><!--Footer-->
    ...
    <script src="<?=ESHOP?>js/fontawesome.js"></script>
    <!-- <script src="<?=ESHOP?>js/solid.min.js"></script> -->
    <!-- <script src="<?=ESHOP?>js/brands.min.js"></script> -->
    <!-- <script src="<?=ESHOP?>js/all.js"></script> -->
</body>
</html>